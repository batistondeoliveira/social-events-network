...
class ModalInviteTable extends AbstractComponent {
    ...
    render() {
        return (
            <div>                
                ...
                {
                    this.props.convidar !== undefined &&
                    <button className="btn btn-success" style={{marginBottom: '15px'}}
                            onClick={() => this.props.convidar()} disabled={this.props.btnConvidarTxt !== 'Enviar Convite'}>
                        { this.props.btnConvidarTxt }
                    </button>
                }
...
export default  ModalInviteTable;